      ...
      <header className="App-header d-flex justify-content-between">
        ...
        <nav className="d-flex align-items-center">
          ...
          <NavLink
            replace={true}
            to="/"
            className="navL homeLink"
            id="homeLink"
            onClick={this.removeScroll.bind(this)}
          >
            Home
          </NavLink>{" "}
          <NavLink to="/" className="navL">
            <div onClick={this.scrollAbout.bind(this)}>About us</div>
          </NavLink>{" "}
          <NavLink
            className="navL"
            replace={true}
            to="/"
            onClick={this.scrollContact.bind(this)}
          >
            Contact
          </NavLink>{" "}
        </nav>
...
const mapStateToProps = ({ selectedItem, homeScroll }) => ({
  selectedItem,
  homeScroll,
});
