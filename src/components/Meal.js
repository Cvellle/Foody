    ...
    return (
      <div className="meal">
          ...
          <div className="inline-block position-relative">
            <div className="details text-left">
              <p className="text-left">
                Categoty: {this.props.selected.category}
              </p>
              <p className="text-left">
                Country: {this.props.selected.country}
              </p>
              <p className="text-left video">
                Video:{" "}
                <a href={this.props.selected.video}>
        ...
        <table>
          ...
          <tr>
            <td>{this.props.selected.ingredient[0].name}</td>
            <td>{this.props.selected.ingredient[0].amount}</td>
          </tr>
          <tr>
            <td>{this.props.selected.ingredient[1].name}</td>
            <td>{this.props.selected.ingredient[1].amount}</td>
          </tr>
          <tr>
            <td>{this.props.selected.ingredient[2].name}</td>
            <td>{this.props.selected.ingredient[2].amount}</td>
          </tr>
          <tr>
            <td>{this.props.selected.ingredient[3].name}</td>
            <td>{this.props.selected.ingredient[3].amount}</td>
          </tr>
        </table>
